...
func (*CollectionRoute) Get(c fiber.Ctx) error {
...
func (*CollectionRoute) Save(c fiber.Ctx) error {
	tokenUser := globals.MustGetTokenUser(c)
...
func (*CollectionRoute) List(c fiber.Ctx) error {
	tokenUser := globals.MustGetTokenUser(c)
	querier := new(models.CollectionQuerier)
...
func (*CollectionRoute) Delete(c fiber.Ctx) error {
	tokenUser := globals.MustGetTokenUser(c)
	querier := new(models.CollectionQuerier)
	if err := c.Bind().URI(querier); err != nil {
...
func (c *CollectionRoute) Register(root fiber.Router) {
